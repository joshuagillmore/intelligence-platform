...
Run: `cd /c/Users/user/intelligence-platform/backend && uv run pytest tests/test_document_clustering.py -v`
...
```bash
cd /c/Users/user/intelligence-platform
...
Run: `cd /c/Users/user/intelligence-platform/backend && uv run pytest tests/test_document_clustering.py::test_kmeans_two_clusters -v`
...
Run: `cd /c/Users/user/intelligence-platform/backend && uv run pytest tests/test_document_clustering.py::test_cluster_documents_produces_tree -v`
...
Run: `cd /c/Users/user/intelligence-platform/backend && uv run pytest tests/test_topics_route.py -v`
Expected: PASS
...
Run: `cd /c/Users/user/intelligence-platform/frontend && npm run build`
