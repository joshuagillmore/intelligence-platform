...
**Outcome:** Foundation for Track B in place — edges now have real per-edge provenance to surface. Next: Cycle 2 prune hard (drop low-value co-occurrence, keep only evidence-backed in-sentence edges).
