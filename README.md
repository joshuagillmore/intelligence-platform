...
**SENTINEL is a continued work in progress.** It is under active development
rather than finished and parked: features are still landing, some areas are mid-
hardening, and the limitations below are current rather than permanent. Treat
what follows as the state of the build today, not a final scope.
